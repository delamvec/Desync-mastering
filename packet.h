...
enum
{
	...
	HEADER_GC_ATTACK							= 12,  // PHASE 2 FULL: Server-authoritative combat
	HEADER_GC_STUN								= 13,
	HEADER_GC_DEAD								= 14,
...
// NOTE: TPacketGCAttack already defined at line ~1451 with PHASE 2 FULL fields
// Old definition removed to prevent C2011 redefinition error
