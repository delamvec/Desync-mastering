...
CPacketInfoCG::CPacketInfoCG()
{
	...
	// SIZEOF DEBUG: Log actual packet sizes used by server
	sys_log(0, "========== PACKET SIZE DEBUG ==========");
	sys_log(0, "sizeof(BYTE) = %lu", (unsigned long)sizeof(BYTE));
	sys_log(0, "sizeof(DWORD) = %lu", (unsigned long)sizeof(DWORD));
	sys_log(0, "sizeof(long) = %lu", (unsigned long)sizeof(long));
	sys_log(0, "sizeof(TPacketCGAttack) = %lu", (unsigned long)sizeof(TPacketCGAttack));
	sys_log(0, "sizeof(TPacketCGMove) = %lu", (unsigned long)sizeof(TPacketCGMove));
	sys_log(0, "=======================================");
}
